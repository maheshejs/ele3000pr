...
# File: 2048.tcl
# Generated on: Sun Feb 06 23:57:32 2022
...
if {[is_project_open]} {
    if {[string compare $quartus(project) "2048"]} {
        puts "Project 2048 is not open"
        set make_assignments 0
    }
} else {
    # Only open if not already open
    if {[project_exists 2048]} {
        project_open -revision 2048 2048
    } else {
        project_new -revision 2048 2048
    }
...
if {$make_assignments} {
    ...
    set_global_assignment -name PROJECT_CREATION_TIME_DATE "17:57:15  FEBRUARY 06, 2022"
    ...
    set_global_assignment -name MIF_FILE ../utils/memory_100.mif
    set_global_assignment -name QIP_FILE ../rtl/clk_gen.qip
    set_global_assignment -name QIP_FILE ../rtl/tilesrom.qip
    set_global_assignment -name SDC_FILE ../constraints/top.sdc
    set_global_assignment -name VERILOG_FILE ../rtl/i2c_controller.v
    set_global_assignment -name VERILOG_FILE ../rtl/i2c_hdmi_config.v
    set_global_assignment -name VERILOG_FILE ../rtl/i2c_write_wdata.v
    set_global_assignment -name VERILOG_FILE ../rtl/render.v
    set_global_assignment -name VERILOG_FILE ../rtl/top.v
    set_global_assignment -name VERILOG_FILE ../rtl/vga_generator.v
    set_global_assignment -name VHDL_FILE ../rtl/clk_rst_gen.vhd
    set_global_assignment -name VHDL_FILE ../rtl/cnt.vhd
    set_global_assignment -name VHDL_FILE ../rtl/dbnc.vhd
    set_global_assignment -name VHDL_FILE ../rtl/delay_cnt.vhd
    set_global_assignment -name VHDL_FILE ../rtl/dp_ram.vhd
    set_global_assignment -name VHDL_FILE ../rtl/game.vhd
    set_global_assignment -name VHDL_FILE ../rtl/game_defs.vhd
    set_global_assignment -name VHDL_FILE ../rtl/line_reader.vhd
    set_global_assignment -name VHDL_FILE ../rtl/line_writer.vhd
    set_global_assignment -name VHDL_FILE ../rtl/merger.vhd
    set_global_assignment -name VHDL_FILE ../rtl/meta_harden.vhd
    set_global_assignment -name VHDL_FILE ../rtl/msa_game.vhd
    set_global_assignment -name VHDL_FILE ../rtl/prbs.vhd
    set_global_assignment -name VHDL_FILE ../rtl/ram_neigh.vhd
    set_global_assignment -name VHDL_FILE ../rtl/randint.vhd
    set_global_assignment -name VHDL_FILE ../rtl/read_manager.vhd
    set_global_assignment -name VHDL_FILE ../rtl/rst_bridge.vhd
    set_global_assignment -name VHDL_FILE ../rtl/shift_reg.vhd
    set_global_assignment -name VHDL_FILE ../rtl/slider.vhd
    set_global_assignment -name VHDL_FILE ../rtl/spawner.vhd
    set_global_assignment -name VHDL_FILE ../rtl/tiles_neighbour.vhd
    set_global_assignment -name VHDL_FILE ../rtl/tiles_ram.vhd
    set_global_assignment -name VHDL_FILE ../rtl/tiles_slirge.vhd
    set_global_assignment -name VHDL_FILE ../rtl/tiles_spawn.vhd
    set_global_assignment -name VHDL_FILE ../rtl/tiles_zero.vhd
    set_global_assignment -name VHDL_FILE ../rtl/write_manager.vhd
    ...
    set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to GPIO_0[27]
    set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to GPIO_0[29]
    set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to GPIO_0[31]
    set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to GPIO_0[33]
    set_instance_assignment -name GLOBAL_SIGNAL GLOBAL_CLOCK -to "i2c_hdmi_config:i2c_hdmi_config_inst|mI2C_CTRL_CLK"
    set_instance_assignment -name GLOBAL_SIGNAL GLOBAL_CLOCK -to "clk_rst_gen:clk_rst_gen_inst|rst_bridge:rst_bridge_game_inst|sig_dst"
    set_instance_assignment -name GLOBAL_SIGNAL GLOBAL_CLOCK -to "clk_rst_gen:clk_rst_gen_inst|rst_bridge:rst_bridge_render_inst|sig_dst"
    set_instance_assignment -name GLOBAL_SIGNAL GLOBAL_CLOCK -to "clk_rst_gen:clk_rst_gen_inst|rst_bridge:rst_bridge_i2c_inst|sig_dst"
